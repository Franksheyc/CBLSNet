function outdata = PermutationEntropy( indata, delay, order, windowSize )
...
% @email UnakafovaValentina(at)gmail.com
 obj=['F:\sleep\open database\feature extraction1\Fast-permutation-entropy-master\table',num2str(order),'.mat'];
 load( obj); % the precomputed table
